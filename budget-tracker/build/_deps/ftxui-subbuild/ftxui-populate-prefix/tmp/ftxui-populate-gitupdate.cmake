...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v5.0.0"
  WORKING_DIRECTORY "/home/kudla/cpp-vsb/budget-tracker/build/_deps/ftxui-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/kudla/cpp-vsb/budget-tracker/build/_deps/ftxui-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/kudla/cpp-vsb/budget-tracker/build/_deps/ftxui-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
